...
import { DeleteComment, LikePost } from "../post.action";
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="col-span-1 flex  border p-4 rounded-md flex-col items-center">
          <h1 className="text-xl text-center">Your feedback</h1>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex flex-col space-y-2">
                <div className="flex items-center space-x-2 ">
                  <HeartIcon />
                  <Badge>{data.article.likes.length} likes</Badge>
                </div>
                <div className="flex items-center space-x-2">
                  <MessageCircle />
                  <Badge>{data.article.comments.length} comments</Badge>
                </div>
              </div>
            </div>
            <div className="mt-4">
              ...
              <div>
                ...
                {data.article.comments.length === 0 && <p>No comments yet.</p>}
